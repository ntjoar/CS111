...
# Test case 1 
echo "Test 1.1"
sort -g a0.txt | tr a-z A-Z | cat > test1_1out.txt ; times > bash1_1.txt
...
echo "File outputs to bash1_1.txt and c1_1time.txt"
echo "---"

# Test case 2
echo "Test 1.2"
cat a0.txt | grep "bottle" | wc -c > test1_2out.txt ; times > bash1_2.txt
...
echo "File outputs to bash1_2.txt and c1_2time.txt"
echo "---"

# Test case 3
echo "Test 1.3"
sort -g a0.txt | cat | grep "vessel" > test1_3out.txt ; times > bash1_3.txt
...
echo "File outputs to bash1_3.txt and c1_3time.txt"
echo "---"

### Interation II ###
# Test case 1 
echo "Test 2.1"
sort -g a0.txt | tr a-z A-Z | cat > test2_1out.txt ; times bash > bash2_1.txt
...
echo "File outputs to bash2_1.txt and c2_1time.txt"
echo "---"

# Test case 2
echo "Test 2.2"
cat a0.txt | grep "bottle" | wc -c > test2_2out.txt ; times bash > bash2_2.txt
...
echo "File outputs to bash2_2.txt and c2_2time.txt"
echo "---"

# Test case 3
echo "Test 2.3"
sort -g a0.txt | cat | grep "vessel" > test2_3out.txt ; times bash > bash2_3.txt
...
echo "File outputs to bash2_3.txt and c2_3time.txt"
echo "---"
...
# Test case 1 
echo "Test 3.1"
sort -g a0.txt | tr a-z A-Z | cat > test3_1out.txt ; times bash > bash3_1.txt
...
echo "File outputs to bash3_1.txt and c3_1time.txt"
echo "---"

# Test case 2
echo "Test 3.2"
cat a0.txt | grep "bottle" | wc -c > test3_2out.txt ; times > bash3_2.txt
...
echo "File outputs to bash3_2.txt and c3_2time.txt"
echo "---"

# Test case 3
echo "Test 3.3"
sort -g a0.txt | cat | grep "vessel" > test3_3out.txt ; times > bash3_3.txt
...
echo "File outputs to bash3_3.txt and c3_3time.txt"
echo "---"

rm -f a0.txt

echo "All c files in c; times folder"
echo "All bash files in bashTimes folder"
mkdir cTimes
mkdir bashTimes
mv c*time.txt cTimes
mv bash*.txt bashTimes